      ...
      <div>
        <div className='frontPage'>
          ...
          <div className='aboutText'>
            <h1>About me</h1>
            <p className='aboutmeStuff'>I am an adaptable Front-End Developer and Marketing professional who loves using technology to create new communities and help companies and brands tell their story. My experience in both marketing and development gives me the unique ability to craft relatable narratives that are accompanied by stunning visual presentations.</p>




            <div className='skillStuff'>
              <h2 className='skillsName'>Skills & Tools</h2>
